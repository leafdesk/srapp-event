...
const questions = [
  {
    id: 1,
    question: (
      <span>문자 등 메신저보다는 통화가 편하다. (적극-반응/적극↑)</span>
    ),
  },
  {
    id: 1,
  ...
  {
    id: 1,
    question: <span>뭐든지 확실하게 하는 게 좋다. (강렬-담백/강렬↑)</span>,
  },
  {
    id: 1,
    question: <span>가끔 10년 뒤 내 모습을 상상한다. (기억-미래/미래↑)</span>,
  },
  {
    id: 1,
    question: (
  ...
  {
    id: 1,
    question: <span>기억력이 좋다는 말을 종종 듣는다. (기억-미래/기억↑)</span>,
  },
  {
    id: 1,
    question: (
      <span>가끔 하고자 했던 말을 잊어버리곤 한다. (기억-미래/미래↑)</span>
    ),
  },
  {
    id: 1,
  ...
  },
  {
    id: 1,
    question: (
      <span>한 번 결심한 건 끝장을 봐야 하는 성격이다. (강렬-담백/강렬↑)</span>
    ),
  },
  {
    id: 1,
    question: (
      <span>
        머리 속이 복잡해질 때, 몸을 움직이면 생각이 정리된다고 느낀다.
        (언어-행동/행동↑)
      </span>
    ),
  },
  {
    id: 1,
    question: (
      <span>예상치 못한 선물로 놀라게 하는 걸 좋아한다. (적극-반응/적극↑)</span>
    ),
  },
  {
    id: 1,
    question: (
      <span>계획을 세우는 일 자체에서 즐거움을 느낀다. (기억-미래/미래↑)</span>
    ),
  },
  {
    id: 1,
    question: (
      <span>일상에서의 작은 배려에 감동을 느낀다. (강렬-담백/담백↑)</span>
    ),
  },
  {
    id: 1,
    question: (
      <span>누군가에게 편지를 쓰는 일은 쉽지 않다. (언어-행동/행동↑)</span>
    ),
  },
  {
    id: 1,
    question: <span>나는 표정이 다양한 편이다. (강렬-담백/강렬↑)</span>,
  },
  { id: 1, question: <span>약속을 먼저 잡는 편이다. (적극-반응/적극↑)</span> },
  {
    id: 1,
    question: (
      <span>
